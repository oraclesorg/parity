...
pub struct HbbftParams {
	...
	/// used to calculate block rewards, to mint new coins after each new block is sealed, and to
	/// distribute the minted coins as block rewards to a set of recipient addresses.
